...
#include "CoreObject/Reflection/PrimitiveProperty.h"
...
void HReflectionTest::__Fill_Class_Property_HReflectionTest(HClass* InStaticClass)
{
	...
	HStructBuilder::AddProperty<HReflectionTest, int32, HNumericProperty>(InStaticClass, HString(L"D"), &HReflectionTest::D);
}
